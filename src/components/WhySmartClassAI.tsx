      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">
            Why Choose <span className="bg-gradient-hero bg-clip-text text-slate-950">SmartClassAI</span>?
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {highlights.map((highlight, index) => <div key={highlight.title} className="group relative bg-card rounded-2xl p-8 shadow-soft hover:shadow-medium transition-smooth animate-slide-in-up" style={{
